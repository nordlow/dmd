...
enum class STC : uint64_t
{
    ...
    unique_ = 36028797018963968LLU,
    safeGroup = 962072674304LLU,
    IOR = 268288LLU,
    TYPECTOR = 36028840002191364LLU,
